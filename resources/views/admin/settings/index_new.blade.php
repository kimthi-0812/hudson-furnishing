                ...
                <form method="POST" action="{{ route('admin.settings.update') }}">
                    ...
                    <ul class="nav nav-pills nav-fill mb-4" id="settingsTabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="seo-tab" data-bs-toggle="pill" data-bs-target="#seo" type="button" role="tab">
                                <i class="fas fa-search me-2"></i>SEO Cấu Hình
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                                    ...
                                    <div class="settings-section">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="site_name" name="site_name" 
                                                   ...
                                                   placeholder="Nhập tên của website">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="site_tagline" name="site_tagline" 
                                                   ...
                                                   placeholder="Nhập tagline của website">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="site_description" name="site_description" rows="3" 
                                                      placeholder="Nhập mô tả của website">{{ $settings['site_description'] ?? 'Hudson Furnishing cung cấp nội thất cao cấp cho mọi phòng trong ngôi nhà của bạn. Chất lượng thủ công gặp gỡ thiết kế hiện đại.' }}</textarea>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="site_keywords" name="site_keywords" 
                                                   ...
                                                   placeholder="Nhập từ khóa của website">
                                            <small class="form-text text-muted">Tách từ khóa bằng dấu phẩy</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="settings-preview">
                                        <div class="section-header mb-3">
                                            ...
                                            <small class="text-muted">Cách thông tin của website sẽ hiển thị</small>
                                        </div>
                                    ...
                                    <div class="settings-section">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="contact_address" name="contact_address" rows="3" 
                                                      placeholder="Nhập địa chỉ liên hệ">{{ $settings['contact_address'] ?? "35/6 Đường D5, Q. Bình Thạnh, TP.HCM 700000" }}</textarea>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="contact-preview">
                                        <div class="section-header mb-3">
                                            ...
                                            <small class="text-muted">Cách thông tin liên hệ sẽ hiển thị</small>
                                        </div>
                                ...
                                <div class="col-md-8">
                                    <div class="settings-section">
                                        <div class="section-header mb-3">
                                            ...
                                            <small class="text-muted">Cấu hình mạng xã hội</small>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="facebook_url" class="form-label">
                                                        <i class="fab fa-facebook text-primary me-1"></i>Facebook URL Link
                                                    </label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="instagram_url" class="form-label">
                                                        <i class="fab fa-instagram text-primary me-1"></i>Instagram URL Link
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="twitter_url" class="form-label">
                                                        <i class="fab fa-twitter text-primary me-1"></i>Twitter URL Link
                                                    </label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="linkedin_url" class="form-label">
                                                        <i class="fab fa-linkedin text-primary me-1"></i>LinkedIn URL Link
                                                    </label>
                                ...
                                <div class="col-md-4">
                                    <div class="social-preview">
                                        <div class="section-header mb-3">
                                            ...
                                            <small class="text-muted">Cách thông tin mạng xã hội sẽ hiển thị</small>
                                        </div>
                            ...
                            <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="google_analytics" class="form-label">
                                                        <i class="fab fa-google text-primary me-1"></i>Google Analytics ID Link
                                                    </label>
                                                    <input type="text" class="form-control" id="google_analytics" name="google_analytics" 
                                                           value="{{ $settings['google_analytics'] ?? '' }}"
                                                           placeholder="G-XXXXXXXXXX Link">
                                                </div>
                                                
                                                <div class="mb-3">
                                                    <label for="meta_author" class="form-label">
                                                        <i class="fas fa-user text-primary me-1"></i>Meta Author Name
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <label for="meta_robots" class="form-label">
                                                        <i class="fas fa-robot text-primary me-1"></i>Tình Trạng Meta Robots
                                                    </label>
                                ...
                                <div class="col-md-4">
                                    <div class="seo-preview">
                                        <div class="section-header mb-3">
                                            <h6 class="text-primary mb-1">
                                                <i class="fas fa-chart-line me-2"></i>Tình Trạng SEO
                                            </h6>
                                            <small class="text-muted">Tình trạng cấu hình SEO</small>
                                        </div>
                                        
                                        <div class="seo-status p-3 bg-light rounded">
                                            <div class="status-item mb-2">
                                                <i class="fas fa-check-circle text-success me-2"></i>
                                                <small>Meta tags cấu hình</small>
                                            </div>
                                            <div class="status-item mb-2">
                                                <i class="fas fa-{{ $settings['google_analytics'] ?? '' ? 'check-circle text-success' : 'times-circle text-warning' }} me-2"></i>
                                                <small>Google Analytics {{ $settings['google_analytics'] ?? '' ? 'đã cấu hình' : 'chưa cấu hình' }}</small>
                                            </div>
                                            <div class="status-item">
                                                <i class="fas fa-{{ $settings['google_maps_api'] ?? '' ? 'check-circle text-success' : 'times-circle text-warning' }} me-2"></i>
                                                <small>Google Maps {{ $settings['google_maps_api'] ?? '' ? 'đã cấu hình' : 'chưa cấu hình' }}</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="settings-section">
                                        <div class="section-header mb-3">
                                            <h6 class="text-primary mb-1">
                                                <i class="fas fa-sliders-h me-2"></i>Cấu Hình Nâng Cao
                                            </h6>
                                            <small class="text-muted">Cấu hình nâng cao website</small>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="items_per_page" name="items_per_page" 
                                                   ...
                                                   placeholder="12">
                                            <small class="form-text text-muted">Số lượng sản phẩm hiển thị trên trang</small>
                                        </div>
                                        
                                        <div class="mb-3">
                                            <label for="maintenance_mode" class="form-label">
                                                <i class="fas fa-tools text-primary me-1"></i>Tình Trạng Maintenance
                                            </label>
                                            ...
                                            <small class="form-text text-muted">Bật để hiển thị trang maintenance cho khách hàng</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="system-info">
                                        <div class="section-header mb-3">
                                            ...
                                            <small class="text-muted">Tình trạng và thông tin hệ thống</small>
                                        </div>
                                        ...
                                        <div class="system-card p-3 bg-light rounded">
                                            ...
                                            <div class="info-item">
                                                ...
                                                <span class="badge bg-{{ config('app.debug') ? 'warning' : 'success' }}">
                                                    {{ config('app.debug') ? 'Đã Bật' : 'Đã Tắt' }}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="text-end mt-4 pt-3 border-top">
                        <button type="submit" class="btn btn-primary btn-lg">
                            <i class="fas fa-save me-2"></i>Lưu Tất Cả Cấu Hình
                        </button>
                    </div>
                </form>
            </div>
