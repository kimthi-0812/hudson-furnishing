...
@section('title', 'Sửa Slide Carousel - Hudson Furnishing')
@section('page-title', 'Sửa Slide Carousel')
    ...
    <div class="col-lg-8">
        <div class="card shadow">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-light">Chỉnh Sửa Slide</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.carousels.update', $carousel) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="sort_order" 
                                       name="sort_order" 
                                       value="{{ old('sort_order', $carousel->sort_order) }}"
                                       min="0"
                                       placeholder="0">
                                @error('sort_order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="3"
                                  placeholder="Nhập mô tả slide (tùy chọn)">{{ old('description', $carousel->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
