...
@section('title', 'Product Details - Hudson Furnishing')
...
<div class="row">
    <div class="col-lg-8">
        ...
        @if($product->reviews->count() > 0)
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Customer Reviews ({{ $product->reviews->count() }})</h6>
                </div>
                <div class="card-body">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <small class="text-muted">Updated: {{ $product->updated_at->format('M d, Y') }}</small>
                </div>
            </div>
        </div>
