...
@section('title', 'Thêm Hình Ảnh Thư Viện - Hudson Furnishing')
@section('page-title', 'Thêm Hình Ảnh Thư Viện')
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="{{ route('admin.independent-gallery.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="3"
                                  placeholder="Nhập mô tả hình ảnh (tùy chọn)">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
